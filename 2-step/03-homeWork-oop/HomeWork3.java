...
public class HomeWork3 {
    ...
    public static void main(String[] args) {
        ...
        // Поскольку метод getPerimeter реализован в суперклассе Figure, он "универсален"
        // В кавычках, потому что он не полностью защищён от дурака
        System.out.println("**********************************");
        ...
        // А вот метод getArea защищён лучше, потому что для каждой фигуры он переопределён
        // внутри своего подкласса. Там и проверки значений лучше.
        System.out.println("**********************************");
